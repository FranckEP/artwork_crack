...
class LocationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    _init(_id!, _name);
    return Scaffold(
      appBar: CustomAppBar(context: context, tile: const Text('Ubicación'), picUrl: 'https://media.admagazine.com/photos/618a6acbcc7069ed5077ca7f/master/w_1600%2Cc_limit/68704.jpg'),
