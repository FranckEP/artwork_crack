      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: const [
          BottomNavigationBarItem(
            icon: Icon(Icons.blur_circular_outlined, color: Color(0xff68CAF0),),
            label: 'Estados',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.message_outlined, color: Color(0xff68CAF0),),
            label: 'Mensajes',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.add_circle_outline_outlined, color: Color(0xff68CAF0),),
            label: 'Nuevo',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.photo_camera_back_outlined, color: Color(0xff68CAF0),),
            label: 'Arte Social',
          ),
          BottomNavigationBarItem(
            icon: Icon(Icons.menu, color: Color(0xff68CAF0),),
            label: 'Menú',
          ),
        ],
